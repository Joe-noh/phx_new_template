...
# PhxNewTemplateWeb.Endpoint.init/2 when load_from_system_env is
...
# start per endpoint:
#
#     config :phx_new_template, PhxNewTemplateWeb.Endpoint, server: true
#
...
#   username: "postgres",
#   password: "postgres",
#   database: "phx_new_template_prod",
#   pool_size: 15
